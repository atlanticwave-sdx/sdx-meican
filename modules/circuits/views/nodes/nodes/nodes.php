    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        ...
        <div class="relative">
            ...
            <!-- Dropdown List -->
            <div id="dropdownContainer" class="absolute w-full mt-1 bg-white border rounded-md shadow-lg hidden">
        ...
        <div class="relative">
            ...
            <div id="dropdownContainer2" class="absolute w-full mt-1 bg-white border rounded-md shadow-lg hidden">
